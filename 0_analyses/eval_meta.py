...
META_FIELDS = [
    ...
    ("clinical diagnosis", "Do you have any clinical diagnoses?"),
    ("STICSA-T somatic", "What is your STICSA-T somatic score?"),
    ("STICSA-T cognitive", "What is your STICSA-T cognitive score?"),
    ("STAI-S", "What is your STAI-S score?"),
    ("STAI-T", "What is your STAI-T score?"),
    ("IUS", "What is your IUS score?"),
    ("RRQ", "What is your RRQ score?"),
    ("AUDIT", "What is your AUDIT score?"),
    ("DAST", "What is your DAST score?"),
    ("PSWQ", "What is your PSWQ score?"),
    ("GAD-7", "What is your GAD-7 score?"),
    ("SDS", "What is your SDS score?"),
    ("OCI", "What is your OCI score?"),
    ("PHQ-9", "What is your PHQ-9 score?"),
    ("PHQ-8", "What is your PHQ-8 score?"),
    ("BAS Drive", "What is your BAS Drive score?"),
    ("BAS Fun Seeking", "What is your BAS Fun Seeking score?"),
    ("BAS Reward Responsiveness", "What is your BAS Reward Responsiveness score?"),
    ("BDI-II", "What is your BDI-II score?"),
    ("BIS-11", "What is your BIS-11 score?"),
    ("BIS-10", "What is your BIS-10 score?"),
]

def has_any_meta(example):
    return any(example[field] != "N/A" for field, _ in META_FIELDS)

def apply_chat_template(example):
    preprompt = ""

    for field, question in META_FIELDS:
        if example[field] != "N/A":
            preprompt += f"Interviewer: {question}\n"
            preprompt += f"Interviewee: {example[field]}\n\n"

    example["text"] = preprompt + example["text"]
    return example
...
if __name__ == "__main__":
    ...
    dataset_full = dataset_full.filter(has_any_meta, num_proc=args.num_proc)
    ...
    for study in dataset_full.unique("study"):
        ...
        folder_path = "data_meta/" + study.replace("/", "-")
