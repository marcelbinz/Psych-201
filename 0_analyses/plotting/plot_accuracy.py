...
df = pd.read_csv("../csvs/full_data_jureca_data_acc.csv")
...
plt.savefig("figures/fig_accuracy.png", dpi=300, bbox_inches="tight")
plt.savefig("figures/fig_accuracy.pdf", bbox_inches="tight")
plt.show()
